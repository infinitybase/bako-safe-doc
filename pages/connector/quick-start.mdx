...
To create your dapp, you can use as a basis the code from the [example application](https://github.com/infinitybase/bako-safe-dapp) that was previously presented.<br/>
