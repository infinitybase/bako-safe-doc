...
- **Bako ID**: Integrating Bako Safe with Bako ID, our identity solution for RollupOS, greatly enhances user experience.
  - Bako ID Documentation
- **Bako Card:** Authenticate and sign with a novel physical card interface, bringing over more control and day-to-day usability to Bako Safe
  - Bako Card Documentation
