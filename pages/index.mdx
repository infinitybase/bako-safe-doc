...
Here we introduce you how integrate with the [BSAFE SDK](./sdk) and the [BSAFE CONNECTOR](./connector) to benefit from the security and flexibility of a multisig environment on your DApps.
