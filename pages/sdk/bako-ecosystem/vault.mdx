...
```
It is also possible to create a vault using payload with a specific [predicate contract version](../version).
...
const predicateVersion = await Vault.BakoSafeGetPredicateVersionByCode(code)
