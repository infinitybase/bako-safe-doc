...
BSafe offers two ways of managing a Vault: **Standalone** and by using the **BSafe Ecosystem**.

- **Standalone**: This implies that the application or system is able to function independently. In the case of BSafe, using it in a standalone mode refers to managing the Multisig Wallet or the Vault on your own.

- **BSafe Ecosystem**: This platform enables seamless management of your Vault within our [app](https://app.bsafe.pro).
...
<Cards num={2}>
    ...
    <Card arrow title="BSafe Ecosystem" href="./bsafe-ecosystem" />
</Cards>
