...
This feature allows you to create and manage your Vault within the BSafe.

<Callout type="warning">
    Please note that authentication is mandatory to integrate with the BSafe Ecosystem. We've provided a method to
    initiate a session. Explore more in our [Authentication Documentation](../authentication).
</Callout>

## Create

The process of creating a Vault within the BSafe Ecosystem is similar to the standalone method, but you need to
