...
BSafe provides an SDK to manage all the logic of a Multisig Wallet. This can be used in two different
ways: `Standalone` or as part of the `BSafe Ecosystem`.

To utilize the `BSafe Ecosystem`, authentication is required. With authentication, it's possible to use several methods, such as:
